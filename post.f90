                          ...
                          if(id_proc.eq.0)then
                             ...
                             if(ndim.eq.1)then
                                ...
                                do i=1,rsample
                                   if(inf(i)(1:2).eq.'1_')then 
                                      ict = ict + 1
                                      xvis(1:ndim,ict) = DS(1,1:ndim)+(DS(2,1:ndim)-DS(1,1:ndim))*sampl(i,1:ndim)
                                      if (fct.ge.20) xvis(1,ict)=xvis(1,ict) * 180.0 / 4.0 /atan(1.0)   ! in degree
                                      fvis(ict,1)   = fun(i)
                                   end if
                                end do
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! added for exporting the samples to MIR
                                ...
                                write(10,'(a)')'variables = "x" "y" "f" "rmse" "EI" "Exact"'
                                write(10,*)'zone i=',imax,' j=',jmax,' datapacking=point'
                                do i=1,imax
                                   do j=1,jmax
                                      write(10,*)TEC2(i,j,1),TEC2(i,j,2),TEC2(i,j,3),TEC2(i,j,4),TEC2(i,j,5),TEC2(i,j,6)
                                   end do
                                end do
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                                ...
                                if (readfromdatabase.eq.0) then
                                   ...
                                   if (fct.le.20) then
                                      ...
                                      write(10,*)'variables= "x","y","f"'
                                      write(10,*)'zone i=',imax,' j=',jmax,' datapacking=point'
                                      
                                      do i=1,imax
                                         do j=1,jmax
                                            write(10,*)TEC2(i,j,1),TEC2(i,j,2),TEC2(i,j,6)
                                         end do
                                      end do
