...
!!$         close(10)
           ...
           do fuct=7,7 !0:exp 1: cos(lin sum) 2: Runge fct 3: Rosenbrock fct 4: Rastrigin 5: Lin (cos plus noise)  6: Trustdesign 7: Quadratic 8: Cubic 9: Short Column, 10:  Cantilever, 11: Three Bar ,20: CFD, 21,22: Optimization
...
!!$                 end if
                       ...
                       do while (nhs.le.maxsample .and. diffloc.gt.diffconv)
                          ...
                          if (dynamics.eq.0) call Make_Sample 
                          iterDEL=iterDEL+1
                          call Read_Set
                          call Read_Sample
                          call Check_Sample
