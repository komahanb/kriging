program Kriging
  ...
  do randomtestl=2,2   
     ...
     diffconv=1.e-6 ! Target agreement between local and global surrogate

     selectedevaluation=0 ! 0: not selected 1: selected 

     filenum=6 ! 6 for screen

     NMCS=0 !dummy here.. set in MC.inp
     ...
     do  Casemode= 0,0      ! 0: Calculate RMSE  1: Output Statistics  2: Optimize using EI
        ...
        do ctest=3,3
           ...
           if (ctest.eq.1) then
              ...
              randomflag=1              !1=LHS,         !2=Nieder           !3=Halton           !4=Hammersley           !5=Sobol           !6=Faure


           else  if (ctest.eq.2) then

              dynamics=1
              lhsdyn=.true.
              randomflag=1

           else  if (ctest.eq.3) then
...
!!$         close(10)
           ...
           do fuct=1,1 !0:exp 1: cos(lin sum) 2: Runge fct 3: Rosenbrock fct 4: Rastrigin 5: Lin (cos plus noise)  6: Trustdesign 7: Quadratic 8: Cubic 9: Short Column, 10:  Cantilever, 11: Three Bar ,20: CFD, 21,22: Optimization
              ...
              do nstattmp=0,0                ! 0: f only  1: f+g  2: f+g+h  3: f+g+hv
                 ...
                 do jjj=1,nruns
                    ...
                    do nsamples=2*NDIM+1,2*NDIM+1  !Makes this many nhs samples initially..
...
!!$                 end if
                       ...
                       if (id_proc.eq.0) then
                          ...
                          if (Casemode.eq.0) then
                             ...
                             if (counter.eq.1) write(93,*) 'Nhs','    L2diff',&
                                  '          Maxdiff','       MaxLocDiff' ,'   MeanLocDiff'
                             ...
                             if (hstat.eq.0) write(94,*) 'Nhs','      RealAVG','        RealVAR', '         KrigAVG',&
                                  '    KrigVAR', '     ErrorAVG','       ErrorVAR'
                             if (hstat.eq.1) write(94,*) 'Nhs','      RealAVG','        RealVAR','         KrigAVG',&
                                  '         KrigVAR','        ErrorAVG','       ErrorVAR','      MM1AVG',&
                                  '         MM1VAR','          LinAVG', '          LinVAR'
                             if (hstat.eq.3) write(94,*) 'Nhs','      RealAVG','        RealVAR','         KrigAVG',&
                                  '         KrigVAR','        ErrorAVG','       ErrorVAR','   MM1AVG','         MM1VAR' ,&
                                  '         LinAVG','           LinVAR','          MM2AVG','      ','   MM2VAR',&
                                  '          QuadAVG','        QuadVAR'
