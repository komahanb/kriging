...
!
!  Differentiation of scf_db_db in forward (tangent) mode:
!   variations   of useful results: vdd
!   with respect to varying inputs: xf
!   RW status of diff variables: xf:in vdd:out
!        Generated by TAPENADE     (INRIA, Tropics team)
!  Tapenade 3.4 (r3375) - 10 Feb 2010 15:08
!
!  Differentiation of scf_db in forward (tangent) mode:
!   variations   of useful results: vd
!   with respect to varying inputs: xb
!   RW status of diff variables: xb:in vd:out
!        Generated by TAPENADE     (INRIA, Tropics team)
!  Tapenade 3.4 (r3375) - 10 Feb 2010 15:08
!
...
SUBROUTINE SCF_DB_DB_DF(iscf, hstat, xf, xfd, xb, xbd0, xbd, tt, pp, v, &
&  vd, vdd, vddd)
  IMPLICIT NONE
