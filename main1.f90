...
!     fctindx=3        !0 for drag, 4 for lift
     InitialMach=0.5d0
     FinalMach=1.5d0
...
!!$         close(10)
        ...
        do fct=6,6           !0:exp 1: cos(lin sum) 2: Runge fct 3: Rosenbrock fct 4: Rastrigin 5: Lin (cos plus noise)  6: Trustdesign 7: Quadratic 8: Cubic 9: Heaviside (Franke) >9: User supplied

           evlfnc=0  ! CFD case exact evaluation for MC needed or not
